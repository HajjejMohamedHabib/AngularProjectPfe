...
@Component({
  ...
  templateUrl: './ajout-vendeur.component.html',
  styleUrls: ['./ajout-vendeur.component.css']
})
export class AjoutVendeurComponent implements OnInit {
 ...
 async pay(): Promise<void> {
  ...
  const payment = {
    ...
    quantity: '1',
    cancelUrl: 'http://localhost:4200/content',
    successUrl: 'http://localhost:4200/content',
  };
